...
def agent_portrayal(agent):
    ...
    if model_config.parameters['game_type'] == "RPS" and model_config.parameters['game_mode'] == "Pure":
    ...
    elif model_config.parameters['game_type'] == "RPS" and model_config.parameters['game_mode'] == "Impure":
